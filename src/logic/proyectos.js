...
import adminSeries from '../img/adminSeries.png';
...
const proyectos = [
    ...
    },
    {
        ...
        description: 'Aplicación de escritorio desarrollada en Java, para gestionar series, con funciones de agregar, editar, eliminar, mostrar y anular. Incluye validaciones en todos los campos y se conecta a una base de datos MySQL.',
        //linkPage: 'https://personaliza-tu-ropa.netlify.app/',
        linkImg: adminSeries,
        linkGitHub: 'https://github.com/javierjaimesar/adminSeries'
    }
]
