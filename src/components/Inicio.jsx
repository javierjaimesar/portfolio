import cv from "../assets/Esteban-Javier-Jaimes-CV.pdf";
  ...
  return (
    <section id="inicio" className="h-screen flex flex-col justify-center px-5">
      <div className="flex flex-wrap-reverse justify-center items-center gap-5">
        <div
          id="main-home-text"
          className="text-center lg:text-left flex flex-col gap-5"
          data-aos="fade-right"
        ...
        >
          ...
          <p className="text-gray-300 text-xl max-w-lg mx-auto lg:ms-0">
            ¡Hola! Soy Esteban Javier Jaimes 👋
          </p>
          <div className="flex flex-grow items-center gap-5 justify-center lg:justify-start">
            ...
            <a
              href={"https://github.com/javierjaimesar"}
              target="_blank"
              rel="noreferrer"
        ...
        >
          <img
            id="imgYo"
            src={imgMe}
            className="border-3 border-green-500 shadow-lg shadow-green-700 aspect-square bg-contain"
            alt="Esteban Javier Jaimes"
          />
        </div>
      </div>
    </section>
